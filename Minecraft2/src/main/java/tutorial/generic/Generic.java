...
public class Generic {
        ...
        public static Generic instance; //DONT DELETE THIS
        ...
        public void load(FMLInitializationEvent event) {
                ...
                MinecraftForge.EVENT_BUS.register(new genericHooks());
                FMLCommonHandler.instance().bus().register(new genericHooks());
